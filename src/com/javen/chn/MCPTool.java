...
public class MCPTool {
    ...
    private static byte[] read(File path, String password) throws Exception {
        ...
        long index = Long.parseLong(versions[0].toString());
    ...
    public static String getChannelIdFromFile(File file, String password) {
        return MCPTool.readContent(file, password);
    }
